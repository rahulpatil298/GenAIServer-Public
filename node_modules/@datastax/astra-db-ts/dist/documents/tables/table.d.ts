import { CreateTableIndexOptions, CreateTableVectorIndexOptions, FoundRow, SomeRow, TableFilter, TableFindOneOptions, TableFindOptions, TableInsertManyOptions, TableInsertManyResult, TableInsertOneResult, TableUpdateFilter, WithSim } from '../../documents';
import { DataAPIHttpClient } from '../../lib/api/clients/data-api-http-client';
import { AlterTableOptions, Db, DropTableOptions, ListTableDefinition, TableOptions } from '../../db';
import { WithTimeout } from '../../lib';
import { TableFindCursor } from '../../documents/tables/cursor';
import { ListIndexOptions, TableIndexDescriptor } from '../../db/types/tables/list-indexes';
/**
 * #### Overview
 *
