import { Collection, FoundDoc, SomeDoc, WithId } from '../documents/collections';
import { RawDataAPIResponse, WithTimeout } from '../lib/api';
import { AstraDbAdmin } from '../administration/astra-db-admin';
import { DataAPIEnvironment, nullish } from '../lib/types';
import { DataAPIDbAdmin } from '../administration/data-api-db-admin';
import { CreateCollectionOptions } from '../db/types/collections/create-collection';
import { DataAPIHttpClient } from '../lib/api/clients/data-api-http-client';
import { FoundRow, SomeRow, Table, TableDropIndexOptions } from '../documents';
import { CollectionOptions } from '../db/types/collections/collection-options';
import { DropCollectionOptions } from '../db/types/collections/drop-collection';
import { CollectionDescriptor, ListCollectionsOptions } from '../db/types/collections/list-collections';
import { RunCommandOptions } from '../db/types/command';
import { TableOptions } from '../db/types/tables/spawn-table';
import { CreateTableDefinition, CreateTableOptions } from '../db/types/tables/create-table';
import { InferTablePrimaryKey, InferTableSchema } from '../db/types/tables/table-schema';
import { DropTableOptions } from '../db/types/tables/drop-table';
import { ListTablesOptions, TableDescriptor } from '../db/types/tables/list-tables';
import { AdminOptions, DbOptions } from '../client/types';
import { InternalRootClientOpts } from '../client/types/internal';
import { AstraDbInfo } from '../administration/types/admin/database-info';
/**
 * #### Overview
 *
