import { Table } from '../../../documents/tables/table';
import { CreateTableColumnDefinitions, CreateTableDefinition, CreateTablePrimaryKeyDefinition, FullCreateTablePrimaryKeyDefinition } from '../../../db/types/tables/create-table';
import { EmptyObj } from '../../../lib/types';
import { DataAPIBlob, DataAPIDate, DataAPIDuration, DataAPITime, DataAPITimestamp, FoundRow, InetAddress, SomeRow, UUID } from '../../../documents';
import { TypeErr } from '../../../documents/utils';
import { DataAPIVector } from '../../../documents/datatypes/vector';
...
type NormalizePK<PK extends CreateTablePrimaryKeyDefinition> = PK extends string ? {
    partitionBy: [PK];
} : PK;
...
type PickCqlType<Def> = Def extends {
    type: infer Type;
} ? Type : Def;
/**
...
type CqlMapType2TsType<Def> = Def extends {
...
type CqlListType2TsType<Def> = Def extends {
    valueType: infer ValueType extends string;
...
type CqlSetType2TsType<Def> = Def extends {
    valueType: infer ValueType extends string;
...
type CqlVectorType2TsType<Def> = Def extends {
    service: unknown;
