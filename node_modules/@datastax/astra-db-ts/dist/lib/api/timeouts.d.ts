import { nullish, OneOrMany } from '../../lib';
import { HTTPRequestInfo } from '../../lib/api/clients';
import { Parser } from '../../lib/validation';
/**
 ...
 * @internal
 */
export declare const EffectivelyInfinity: number;
/**
 * @internal
 */
export declare class Timeouts {
    private readonly _mkTimeoutError;
    readonly baseTimeouts: TimeoutDescriptor;
    constructor(_mkTimeoutError: MkTimeoutError, baseTimeouts: TimeoutDescriptor);
    single(key: Exclude<keyof TimeoutDescriptor, 'requestTimeoutMs'>, override: WithTimeout<any> | nullish): TimeoutManager;
    multipart(key: Exclude<keyof TimeoutDescriptor, 'requestTimeoutMs'>, override: WithTimeout<any> | nullish): TimeoutManager;
    custom(peek: Partial<TimeoutDescriptor>, advance: () => [number, TimedOutCategories]): TimeoutManager;
    static Default: TimeoutDescriptor;
    static merge(base: TimeoutDescriptor, custom: Partial<TimeoutDescriptor> | nullish): TimeoutDescriptor;
    static fmtTimeoutMsg: (tm: TimeoutManager, timeoutTypes: TimedOutCategories) => string;
    static parseConfig: Parser<Partial<TimeoutDescriptor> | undefined>;
}
